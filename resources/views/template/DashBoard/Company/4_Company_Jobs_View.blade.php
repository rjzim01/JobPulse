                ...
                <div class="col-md-8 p-4">
                    ...
                    <form method="POST" action="{{ route('CompanyJobViewUpdate', ['jobId' => $job->id]) }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" value="{{ optional($job)->title }}"
                                    name="title">
                            </div>
                        </div>
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <select class="form-select" name="category">
                                        <option value="{{ optional($job)->category }}">{{ optional($job)->category }}
                                        </option>
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    ...
                                    <select class="form-select" name="skill1">
                                        <option value="{{ optional($job)->skill1 }}">{{ optional($job)->skill1 }}
                                        </option>
                                    ...
                                    <select class="form-select" name="skill2">
                                        <option value="{{ optional($job)->skill2 }}">{{ optional($job)->skill2 }}
                                        </option>
                                        <option value="Java">Java</option>
                                        <option value="Php">Php</option>
                                        <option value="Python">Python</option>
                                    ...
                                    <select class="form-select" name="skill3">
                                        <option value="{{ optional($job)->skill3 }}">{{ optional($job)->skill3 }}
                                        </option>
                                        <option value="Java">Java</option>
                                        <option value="Php">Php</option>
                                        <option value="Python">Python</option>
                                    ...
                                    <select class="form-select" name="skill4">
                                        <option value="{{ optional($job)->skill4 }}">{{ optional($job)->skill4 }}
                                        </option>
                                        <option value="Java">Java</option>
                                        <option value="Php">Php</option>
                                        <option value="Python">Python</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" value="{{ optional($job)->salary }}"
                                    name="salary">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" value="{{ optional($job)->location }}"
                                    name="location">
                            </div>
                        </div>
                            ...
                            <div class="col-md-7">
                                <div class="input-group">
                                    <input type="text" class="form-control"
                                        value="{{ date('d F Y', strtotime(optional($job)->deadline)) }}" readonly>
                                    {{-- <input type="date" class="form-control"
                                        value="{{ date('d F Y', strtotime(optional($job)->deadline)) }}"
                                        name="deadline"> --}}
                                    <input type="date" class="form-control"
                                        value="{{ optional($job)->deadline ? date('Y-m-d', strtotime($job->deadline)) : '' }}"
                                        name="deadline">
                    ...
                    <div class="card" style="background: rgb(255, 255, 255)">
                        <div class="card-body">
                            <h5 class="card-title"><a
                                    href="{{ route('CompanyApply', ['jobId' => $job->id]) }}">Applied
                                    (<strong>{{ $jobApply }}</strong>) </a></h5>
                        </div>
                    </div>
                </div>
            </div>
