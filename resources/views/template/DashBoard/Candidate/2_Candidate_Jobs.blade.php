...
<main id="main" class="main" style="min-height: 610px">
    ...
    <div class="text-center">
        ...
        <h4 style="text-align:right;">
            <strong id="jobsSortByNameBtn"
                style="background: rgb(233, 233, 233); color: black; padding: 0px 10px 0px 10px; cursor: pointer;">Title</strong>
            <strong id="jobsSortByDateBtn"
                style="background: rgb(233, 233, 233); color: black; padding: 0px 10px 0px 10px; cursor: pointer;">Date</strong>
        </h4>
                    ...
                    @foreach ($jobs as $job)
                        <tr>
                            ...
                            <td class="text-center">
                                <span class="rounded"
                                    style="padding: 5px 20px 5px 23px; background: rgb(0, 255, 0); cursor: pointer; margin: 0px 2px 0px 0px;">
                                    <a href="{{ route('JobView', ['jobId' => $job->id]) }}"
                                        style="text-decoration: none;  color:rgb(55, 55, 55);">View</a>
                                </span>
                            </td>
                        </tr>
                    @endforeach
