        ...
        <div class="col-lg-8">
          <div class="row">
            ...
            <div class="col-xxl-4 col-xl-12">
              <div class="card info-card customers-card">
                <div class="card-body">
                  <h5 class="card-title text-center">Pages</h5>
                  <div class="row">
                    <div class="d-flex justify-content-end">
                      <span id="toggle_button_pages" class="bg-light border rounded ps-1 pe-1" style="cursor: pointer;">Deactivate</span>
                    </div>
                  </div>
                </div>
              </div>
...
<script>
  ...
  document.getElementById("toggle_button_pages").addEventListener("click", function() {
    toggle_sidebar_visibility("toggle_button_pages", "side_bar_pages");
  });
