    ...
    <div class="border p-3">
      <form action="{{ route('HomePageStoreAdmin') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input type="text" name="title" value="{{ optional($homePageData)->title }}" class="form-control" style="width: 50%;">
        </div>
        ...
        <div class="form-group">
          ...
          <input type="text" name="sub_title" value="{{ optional($homePageData)->sub_title }}" class="form-control">
        </div>
        ...
        <div class="content" style="text-align: center; margin:10px 0px 10px 0px; padding: 10px 10px 10px 10px; background: rgb(253, 253, 253); min-height: 100px;">
          <img id="imagePreview" src="{{ url('upload/homeBanner/' . optional($homePageData)->bg_img)  }}" style="display: block;" height="95vh" width="100%">
        </div>
