          ...
          <div class="card px-5 py-5">
            <div class="row justify-content-between ">
                <div class="align-items-center col">
                    <h4><a style="color: black;" href="{{ route('AdminEmployeeCreate') }}">Create Employee</a></h4>
                </div>
            </div>
            <hr class="bg-dark "/>
...
<script>
  ...
  async function getList() {
    ...
    let res=await axios.get("/api/Admin/Employee");
    ...
    $('.editBtn').on('click', async function () {
      ...
      window.location.href = `/AdminRoll/edit/${companyId}`;
    })
